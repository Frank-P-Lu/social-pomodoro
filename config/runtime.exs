...
#
#     PHX_SERVER=true bin/social_pomodoro start
#
...
if config_env() == :prod do
  ...
  config :social_pomodoro, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :social_pomodoro, SocialPomodoro.Mailer,
