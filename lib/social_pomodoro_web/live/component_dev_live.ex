    ...
    <Layouts.app flash={@flash}>
      <div class="space-y-12">
        <section class="space-y-3">
          <p class="text-sm uppercase tracking-widest text-base-content/60 font-semibold">
            Playground
          </p>
          <h1 class="text-3xl font-semibold tracking-tight text-base-content">Component sandbox</h1>
          <p class="text-base text-base-content/70 max-w-2xl">
            Use this page to tinker with UI ideas without touching the primary flows. Everything below is
            safe to experiment with—adjust copy, breakpoints, spacing, and more.
          </p>
        </section>
